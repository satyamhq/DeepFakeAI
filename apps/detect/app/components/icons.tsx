// Curated set of SVGs we use in the site collected from https://flowbite.com/icons/
// Why doesn't Flowbite already allow us to refer to icons as components like this?
// Seems Flowbite isn't included in https://react-icons.github.io/react-icons/
...
export const FlowbiteClipboardIcon = () => (
  <svg
    className="inline w-6 h-6"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const FlowbiteLayersIcon = () => (
  <svg
    className="inline w-6 h-6"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const FlowbiteLifeSaverIcon = () => (
  <svg
    className="inline w-6 h-6"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
//export const FlowbiteBarsIcon = ({ classes }: { classes: string }) => (
export const FlowbiteBarsIcon = () => (
  <svg
    className="inline w-6 h-6"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const FlowbiteBuildingIcon = () => (
  <svg
    className="inline w-6 h-6"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const FlowbiteArrowUpRightFromSquare = () => (
  <svg
    className="inline w-6 h-6"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const FlowbiteCheckBadgeIcon = ({ className }: { className?: string }) => (
  <svg
    className={className}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const FlowbiteCheckBadgeOpenIcon = ({ className }: { className?: string }) => (
  <svg
    className={className}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const FlowbiteEnvelopeIcon = ({ className }: { className?: string }) => (
  <svg
    className={className}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const FlowbiteBellRingingIcon = ({ className }: { className?: string }) => (
  <svg
    className={className}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const FlowbiteUserOutline = ({ className }: { className?: string }) => (
  <svg
    className={className}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const TruthSocial = ({ className }: { className?: string }) => (
  <svg className={className} width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_4493_116)">
      <path d="M16 9.33592H11.8097V12.7456H16V9.33592Z" fill="#E5E7EB" />
      <path d="M14.3622 3.44366V0H5.82375V12.7126H10.1819V3.44366H14.3622Z" fill="#E5E7EB" />
      <path d="M0 0H4.18382V3.44279H0V0Z" fill="#E5E7EB" />
    </g>
    <defs>
      <clipPath id="clip0_4493_116">
        <rect width="16" height="13" fill="currentColor" />
      </clipPath>
    </defs>
  </svg>
)
